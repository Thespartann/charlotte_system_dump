...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'CONFIGURE_CPPFLAGS': '',
 'CONFIG_ARGS': "'--build=x86_64-linux-gnu' '--host=aarch64-linux-android' "
                "'--disable-ipv6' "
                "'--enable-shared' 'ac_cv_file__dev_ptmx=no' "
 ...
 'MODOBJS': 'Modules/_threadmodule.o  Modules/posixmodule.o  '
            ...
            'Modules/symtablemodule.o  Modules/_struct.o  Modules/xxsubtype.o',
 'MODULE_OBJS': '\\',
 ...
 'PYTHONPATH': ':',
 'PYTHON_FOR_BUILD': '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
