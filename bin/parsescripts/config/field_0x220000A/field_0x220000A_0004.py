#######################################################################################################################################
#   filename        :   analysis_mscc_dump_info.py
#
#   author          :   j00354216
#
...
def analysis_gunas_mntn_log_MsCfgInfo_info( instream, outstream):
		...
		outstream.writelines(["CustomCfgInfo_MultiModeEmcCfg_MultiModeEmcSupportFlag:%X\n" % struct.unpack('B', instream.read(1))])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:%X\n" % ucReserve])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:%X\n" % ucReserve])
...
def analysis_gunas_mntn_log_NwInfo_info( instream, outstream):
		outstream.writelines(["ucNrLteN26Ind:%X\n" % struct.unpack('B', instream.read(1))])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:%X\n" % ucReserve])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:%X\n" % ucReserve])
        ...
        outstream.writelines(["GuCapInfo_NwImsVoCap:%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["GuCapInfo_NwBsCap:%X\n" % struct.unpack('B', instream.read(1))])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:%X\n" % ucReserve])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:%X\n" % ucReserve])

        outstream.writelines(["LteCapInfo_NwImsVoCap:%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["LteCapInfo_NwBsCap:%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["LteCapInfo_LteCsCap:%X\n" % struct.unpack('B', instream.read(1))])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:%X\n" % ucReserve])
        
        outstream.writelines(["NrCapInfo_VoPsInd:%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["NrCapInfo_EmsInd:%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["NrCapInfo_EmsFallBackInd:%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["NrCapInfo_SmsOverNasAllowed:%X\n" % struct.unpack('B', instream.read(1))])
