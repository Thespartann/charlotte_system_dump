#######################################################################################################################################
#   filename        :   analysis_cnas_dump_info.py
#
#   author          :   w00316404
#
...
def analysis_cnas_mntn_log_CnasCcbMntnSaveExcLog_info( instream, outstream):
        ...
        outstream.writelines(["ModemInfo_CurRealModemId:%X\n" % struct.unpack('H', instream.read(2))])
...
def analysis_cnas_mntn_log_CnasXregMntnSaveExcLog_info( instream, outstream):
        ...
        outstream.writelines(["CnasXregStateInfo_IsTiPowerOffEstCnfValid:%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["CnasXregStateInfo_NormalServiceFlg:%X\n" % struct.unpack('B', instream.read(1))])
