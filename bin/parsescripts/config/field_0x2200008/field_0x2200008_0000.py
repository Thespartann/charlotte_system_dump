#######################################################################################################################################
#   filename        :   analysis_gunas_dump_info.py
#
#   author          :   benxiaojin
#
...
def analysis_cas_hrpd_per_ota_codec_dump_info( instream, fileLocalOffset, outstream):	
    ...
    while ulLooper < MACRO_CAS_HRPD_MNTN_OTA_CODEC_MAX_LENGTH:
        ...
        if ulLooper == 0:
            outstream.writelines(["%02X " % (ucData)])
...
def analysis_cas_dump_info( infile, offset, outfile):
        ...
        outstream.writelines(["\n**************************** 1X:analysis_cas_dump_info end! %d*******************************\n" % (fileOffset)])
        #save2file.writelines(["\n**************************** 1X:analysis_cas_dump_info end! %d*******************************\n" % (fileOffset)])
        ...
        outstream.writelines(["\n**************************** 1X:analysis cas inqueue msg end! %d*******************************\n\n\n" % (fileOffset)])
        #save2file.writelines(["\n**************************** 1X:analysis cas inqueue msg end! %d*******************************\n\n\n" % (fileOffset)])
        ...
        outstream.writelines(["\n**************************** HRPD:analysis cas handled msg end! %d*******************************\n" % (fileOffset)])
        #save2file.writelines(["\n**************************** HRPD:analysis cas handled msg end! %d*******************************\n" % (fileOffset)])
        ...
        #save2file.writelines(["\n**************************** HRPD:analysis cas inqueue msg begin!*******************************\n"])
        analysis_cas_inqueue_msg_list_dump_info( instream, fileOffset, outstream)
        outstream.writelines(["\n**************************** HRPD:analysis cas inqueue msg end! %d*******************************\n" % (fileOffset)])
        #save2file.writelines(["\n**************************** HRPD:analysis cas inqueue msg end! %d*******************************\n" % (fileOffset)])
